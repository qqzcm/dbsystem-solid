...
public class DbScanRTreeDataFetchAction implements DataFetchAction<KstcQuery, RTree> {

    private Log log = LogFactory.get();

    private static final String CACHE_KEY_PREFIX = "DBSCAN_RTREE_DATA_BY_KEYWORDS:{0}";

    private LRUCache<String,RTree> rTreeLRUCache = CacheUtil.newLRUCache(64, 60 * 60 * 1000L);

    @Override
    public String getCommand() {
        return DataFetchConstant.LOAD_DBSCAN_RTREE_DATA_BY_KEYWORDS;
    }
